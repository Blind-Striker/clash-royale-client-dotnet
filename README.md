...
| ----------------- | -------- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| Clash Royale API Client | Windows  | Azure Pipelines | [![Build Status](https://denizirgindev.visualstudio.com/clash-royale-client-dotnet/_apis/build/status/Clash%20Royale%20API%20Client%20-%20Windows?branchName=master)](https://denizirgindev.visualstudio.com/clash-royale-client-dotnet/_build/latest?definitionId=28&branchName=master) |                   |
| Clash Royale API Client | Ubuntu   | Azure Pipelines | [![Build Status](https://denizirgindev.visualstudio.com/clash-royale-client-dotnet/_apis/build/status/Clash%20Royale%20API%20Client%20-%20Ubuntu?branchName=master)](https://denizirgindev.visualstudio.com/clash-royale-client-dotnet/_build/latest?definitionId=26&branchName=master)  |                   |
| Clash Royale API Client | MacOS    | Azure Pipelines | [![Build Status](https://denizirgindev.visualstudio.com/clash-royale-client-dotnet/_apis/build/status/Clash%20Royale%20API%20Client%20-%20MacOs?branchName=master)](https://denizirgindev.visualstudio.com/clash-royale-client-dotnet/_build/latest?definitionId=27&branchName=master) |
