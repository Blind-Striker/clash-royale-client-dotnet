...
namespace Pekka.Core.Tests.RestApiClientTests
{
    public class CallAsyncTests
    {
        ...
        [Theory, InlineData("GET", "pull_request", null, null), InlineData("POST", "commits", null, null), InlineData("PUT", "commits", null, null),
            ...
            string httpMethodStr, string path, string queryParams, string headerParams)
        {
            ...
            httpMessageHandler.Protected()
                              ...
                              .ReturnsAsync(new HttpResponseMessage() {StatusCode = HttpStatusCode.OK, Content = new StringContent("[{'id':1,'value':'1'}]"),})
                              .Verifiable();
