...
namespace Pekka.RoyaleApi.Client.Clients
{
    public class TournamentClient : ITournamentClient
    {
        ...
        public async Task<ApiResponse<List<Tournament>>> GetOpenTournamentsResponseAsync(TournamentFilter tournamentFilter = null)
        {
        ...
        public async Task<ApiResponse<List<Tournament>>> GetKnownTournamentsResponseAsync(TournamentFilter tournamentFilter = null)
        {
        ...
        public async Task<ApiResponse<List<Tournament>>> Get1KTournamentsResponseAsync(TournamentFilter tournamentFilter = null)
        {
        ...
        public async Task<ApiResponse<List<Tournament>>> GetInPrepTournamentsResponseAsync(TournamentFilter tournamentFilter = null)
        {
        ...
        public async Task<ApiResponse<List<Tournament>>> GetFullTournamentsResponseAsync(TournamentFilter tournamentFilter = null)
        {
        ...
        public async Task<ApiResponse<List<Tournament>>> GetJoinableTournamentsResponseAsync(TournamentFilter tournamentFilter = null)
        {
