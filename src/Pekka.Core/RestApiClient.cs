...
namespace Pekka.Core
{
    public class RestApiClient : IRestApiClient
    {
        ...
        public async Task<IApiResponse<TModel>> GetApiResponseAsync<TModel>(string path, IList<KeyValuePair<string, string>> queryParams = null,
        ...
        public async Task<IApiResponse<TModel>> GetApiResponseAsync<TModel>(HttpRequestMessage httpRequestMessage, NamingStrategy namingStrategy = null)
            where TModel : class
        {
        ...
        public async Task<TModel> GetAsync<TModel>(string path, IList<KeyValuePair<string, string>> queryParams = null, IDictionary<string, string> headerParams = null,
        ...
        public async Task<string> GetStringContentAsync(string path, IList<KeyValuePair<string, string>> queryParams = null,
        ...
        public async Task<HttpResponseMessage> CallAsync(HttpMethod httpMethod, string path, IList<KeyValuePair<string, string>> queryParams = null,
                                                         IDictionary<string, string> headerParams = null)
        {
            Ensure.ArgumentNotNullOrEmptyString(path, nameof(path));

            using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage(httpMethod, path).AddQueryParameters(queryParams).AddHeaders(headerParams))
            {
